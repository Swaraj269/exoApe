...
function Navbar() {
  return (
    <div className="h-24 md:h-24 lg:h-32 flex justify-between items-center lg:px-16 md:px-12 sm:px-8 px-4 w-full fixed top-0 z-[300]">
      <div className="logodiv w-28">
        <div className="logocontainer overflow-hidden">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <svg
              ...
              className="navlogo w-full text-white "
            >
              <path
      ...
      <div className="menubutton cursor-pointer flex gap-2 items-center sm:hidden">
        <h1 className="text-white text-lg font-[light]">Menu</h1>
        <div className="menuicon text-2xl text-white">
          <MdOutlineMenu />
        </div>
      </div>
      <div className="navbarlinks gap-8 hidden sm:flex">
        {["Work", "Studio", "News", "Contact"].map((elem, idx) => {
          return (
            <motion.div
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
            ...
            >
              <h1 className="text-white  sm:text-sm lg:text-[1.05vw] font-[200] font-[light]">
                {elem}
              </h1>
            </motion.div>
          );
